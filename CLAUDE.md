...
- ระยะถัดไปที่เสนอไว้ (ยังไม่ทำ): URL ต่อหน้า/ต่อหัวข้อ + ปุ่ม Back · กระโดดไปหัวข้อ/«อ่านต่อ» ตกผิดที่เพราะกล่องด้านบนยังไม่โหลด ·
  โหลดดัชนีค้นหา (4.5 MB gzip) เมื่อเริ่มค้นหาแทนโหลดทุกครั้ง · ค้นหาเรียงผล/ไฮไลต์/บล็อกสรุป · สำรอง-นำเข้าความคืบหน้า ·
  แยก app.js รายวิชา · PWA ออฟไลน์ · เก็บต้นฉบับใน `_work/` เข้า git (repo private) · CSS ซ้ำรายวิชา
